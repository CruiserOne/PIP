...
// PC program created 10/20/2018 - 7/20/2022 by Walter D. Pullen (Astara@msn.com)
...
#define ClearB(pb, cb) _ClearB((char *)pb, cb)
void _ClearB(char *pb, int cb) { while (cb--) *pb++ = 0; }
